...
class Service extends AppModel{
	...
	public function customUploadImg($file = array()){
		...
		$this->resizeImg($path, $path_th, 66, 66, $ext);
	...
	public function resizeImg($target, $dest, $wmax = 647, $hmax = 647, $ext){
		...
		*/
		...
		$newImg = imagecreatetruecolor(66, 66); // создаем оболочку для новой картинки
		...
		imagecopyresampled($newImg, $img, 0, 0, 0, 0, 66, 66, $w_orig, $h_orig); // копируем и ресайзим изображение
		switch($ext){
			case("gif"):
